...
//================================================================================
// Devuelve si alg�n jugador del equipo especificado esta en el rango indicado
// cerca de la posici�n indicada
//================================================================================
...
//================================================================================
// Devuelve si alg�n jugador esta en la l�nea de fuego (FOV) de un punto de salida
...
//================================================================================
// Devuelve si la posici�n es v�lida usando los filtros de [criteria]
//================================================================================
bool Utils::IsValidSpot( const Vector & vecSpot, const Vector & vecOrigin, const CSpotCriteria & criteria, CPlayer * pOwner )
{
    ...
    // Este escondite esta en la l�nea de fuego
...
//================================================================================
// Devuelve una posici�n donde ocultarse en un rango m�ximo
//================================================================================
// Los Bots lo usan como primera opci�n para ocultarse de los enemigos.
//================================================================================
bool Utils::FindNavCoverSpot( Vector *vecResult, const Vector &vecOrigin, const CSpotCriteria &criteria, CPlayer *pPlayer, SpotVector *list )
{
    ...
    while ( true ) {
        ...
        // No se ha encontrado ning�n lugar 
...
//================================================================================
// Devuelve una posici�n donde ocultarse dentro del area indicado
//================================================================================
// Los Bots lo usan como �ltima opci�n para ocultarse de los enemigos.
//================================================================================
...
//================================================================================
// Devuelve una posici�n donde ocultarse usando los ai_hint (CAI_Hint)
//================================================================================
// Los Bots lo usan como segunda opci�n para ocultarse de los enemigos.
//================================================================================
...
//================================================================================
// Devuelve una posici�n donde el jugador puede ocultarse
//================================================================================
