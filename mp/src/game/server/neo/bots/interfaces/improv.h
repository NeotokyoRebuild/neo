 ...
 * 
 * Bitl:
 * Changed to reflect the features of CImprovLocomotor, which CSS uses.
 * Since there are some similar functions from HL1/CS 1.6, it's easy to comment out the majority of these functions for the ones we need.
 */
...
public:
	...
	//virtual bool IsSneaking(void) const = 0;
