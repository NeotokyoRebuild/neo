...
//================================================================================
// Devuelve si el escuadron se llama as�
//================================================================================
...
//================================================================================
// Devuelve el l�der del escuadron
//================================================================================
...
//================================================================================
// Establece el l�der del escuadron
//================================================================================
...
void CSquad::RemoveMember( CPlayer *member ) 
{
    ...
    if ( GetLeader() == member )
    {
        ...
        {
            // Buscamos el primer miembro activo y lo convertimos en l�der
            // @TODO: Una forma m�s flexible
            FOR_EACH_MEMBER( {
                SetLeader( pMember );
                break;
            } );
...
//================================================================================
// Devuelve si alg�n miembro del escuadron esta mirando al objetivo
//================================================================================
...
//================================================================================
// Devuelve si alg�n miembro del escuadron esta mirando el lugar objetivo
//================================================================================
...
//================================================================================
// Devuelve si alg�n miembro del escuadron se dirige a la ubicaci�n
//================================================================================
bool CSquad::IsSomeoneGoing( const Vector & vecDestination, CPlayer *pIgnore )
{
    FOR_EACH_VEC( m_nMembers, it )
    {
        ...
        // @TODO: Implementaci�n para humanos
        if ( !pMember->IsBot() )
            continue;
...
//================================================================================
// Devuelve si la entidad especificada es enemigo de alg�n miembro del escuadron
// @TODO: Quiz� se deba devolver el miembro que lo tiene como enemigo?
//================================================================================
