...
constexpr auto NEO_SLOW_MODIFIER = 0.75f;

constexpr auto NEO_RECON_WALK_SPEED = 127.5;
constexpr auto NEO_RECON_NORM_SPEED = 170.0;
constexpr auto NEO_RECON_SPRINT_SPEED = 229.5;
constexpr auto NEO_RECON_DUCK_SPEED = NEO_RECON_WALK_SPEED;
constexpr auto NEO_RECON_DUCKSPRINT_SPEED = 172.13;
constexpr auto NEO_RECON_DUCKWALK_SPEED = 95.63;

constexpr auto NEO_ASSAULT_WALK_SPEED = 102.0;
constexpr auto NEO_ASSAULT_NORM_SPEED = 136.0;
constexpr auto NEO_ASSAULT_SPRINT_SPEED = 217.6;
constexpr auto NEO_ASSAULT_DUCK_SPEED = NEO_ASSAULT_WALK_SPEED;
constexpr auto NEO_ASSAULT_DUCKSPRINT_SPEED = 163.2;
constexpr auto NEO_ASSAULT_DUCKWALK_SPEED = 76.5;

constexpr auto NEO_SUPPORT_WALK_SPEED = 102.0;
constexpr auto NEO_SUPPORT_NORM_SPEED = 136.0;
constexpr auto NEO_SUPPORT_SPRINT_SPEED = 136.0;
constexpr auto NEO_SUPPORT_DUCK_SPEED = NEO_SUPPORT_WALK_SPEED;
constexpr auto NEO_SUPPORT_DUCKSPRINT_SPEED = NEO_SUPPORT_WALK_SPEED;
constexpr auto NEO_SUPPORT_DUCKWALK_SPEED = 76.5;
...
COMPILE_TIME_ASSERT(NEO_RECON_DUCK_SPEED != 0);
...
COMPILE_TIME_ASSERT(NEO_ASSAULT_DUCK_SPEED != 0);
...
COMPILE_TIME_ASSERT(NEO_SUPPORT_DUCK_SPEED != 0);
