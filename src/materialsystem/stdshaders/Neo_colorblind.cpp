...
ConVar mat_neo_colorblind_shift_rgb("mat_neo_colorblind_shift_rgb", "0", FCVAR_CHEAT | FCVAR_ARCHIVE, "Reorder RGB color values.\n\t0: RGB (regular order)\n\t1: GBR\n\t2: BRG\n\t3: BGR\n\t4: GRB\n\t5: RBG", true, 0.0f, true, 5.0f);
ConVar mat_neo_colorblind_deuteranopia_mode("mat_neo_colorblind_deuteranopia_mode", "0", FCVAR_CHEAT | FCVAR_ARCHIVE, "Enable deuteranopia adjustment. 0: disabled, 1: simulate deuteranopia colors, 2: apply color correction, 3: simulate color corrected deuteranopia colors", true, 0.0f, true, 3.0f);
ConVar mat_neo_colorblind_deuteranopia_brightness("mat_neo_colorblind_deuteranopia_brightness", "1.2", FCVAR_CHEAT | FCVAR_ARCHIVE, "Post-effect brightness scaler", true, 0.0f, true, 2.2f);
...
ConVar mat_neo_colorblind_deuteranopia_saturation_b("mat_neo_colorblind_deuteranopia_saturation_b", "1.0", FCVAR_CHEAT | FCVAR_ARCHIVE, "Post-effect saturation adjust exclusively for the blue channel", true, 0.0f, true, 2.0f);
