...
ConVar cl_neo_crosshair_network("cl_neo_crosshair_network", "1", FCVAR_ARCHIVE | FCVAR_USERINFO, "Network crosshair - 0 = disable, 1 = show other players crosshair", true, 0.0f, true, 1.0f);
