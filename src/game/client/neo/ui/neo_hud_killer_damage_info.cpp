...
ConVar cl_neo_kdinfo_toggletype("cl_neo_kdinfo_toggletype", "0", FCVAR_ARCHIVE,
		"Killer damage information HUD toggle behavior, 0 = default (auto show based on toggle per match), 1 = always auto show, 2 = never auto show",
...
void CNEOHud_KillerDamageInfo::UpdateStateForNeoHudElementDraw()
{
	...
	if (bNextPlayerShownHud && bNextPlayerShownHud != m_bPlayerShownHud)
	{
