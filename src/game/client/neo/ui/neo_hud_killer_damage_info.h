...
{
	KDMGINFO_TOGGLETYPE_MATCH = 0, // m_bShowInfo not changed on death/end, per match toggle
	KDMGINFO_TOGGLETYPE_ROUND, // m_bShowInfo always set to true on death/end, per round toggle
