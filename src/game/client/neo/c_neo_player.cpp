...
void C_NEO_Player::Spawn( void )
{
	...
	static_assert(_ARRAYSIZE(m_rfAttackersScores) == (MAX_PLAYERS + 1));
	static_assert(_ARRAYSIZE(m_rfAttackersAccumlator) == (MAX_PLAYERS + 1));
	static_assert(_ARRAYSIZE(m_rfAttackersHits) == (MAX_PLAYERS + 1));
