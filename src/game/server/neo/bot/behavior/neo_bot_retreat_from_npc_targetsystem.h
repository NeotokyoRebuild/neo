...
class CNEOBotRetreatFromNPCTargetSystem : public Action< CNEOBot >
{
public:
	CNEOBotRetreatFromNPCTargetSystem( float hideDuration = -1.0f );
	CNEOBotRetreatFromNPCTargetSystem( Action< CNEOBot > *actionToChangeToOnceCoverReached );
	...
	virtual const char *GetName( void ) const	{ return "RetreatFromNPCTargetSystem"; };
