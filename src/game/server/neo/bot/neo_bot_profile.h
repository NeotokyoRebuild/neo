...
enum BotTemplateApplied_
{
	...
	BOT_TEMPLATE_APPLIED_LOOT_WEP_PREF_RECON_PRIVATE      = 1 << 19,
	BOT_TEMPLATE_APPLIED_LOOT_WEP_PREF_RECON_CORPORAL     = 1 << 20,
	BOT_TEMPLATE_APPLIED_LOOT_WEP_PREF_RECON_SERGEANT     = 1 << 21,
	BOT_TEMPLATE_APPLIED_LOOT_WEP_PREF_RECON_LIEUTENANT   = 1 << 22,
	BOT_TEMPLATE_APPLIED_LOOT_WEP_PREF_ASSAULT_PRIVATE    = 1 << 23,
	BOT_TEMPLATE_APPLIED_LOOT_WEP_PREF_ASSAULT_CORPORAL   = 1 << 24,
	BOT_TEMPLATE_APPLIED_LOOT_WEP_PREF_ASSAULT_SERGEANT   = 1 << 25,
	BOT_TEMPLATE_APPLIED_LOOT_WEP_PREF_ASSAULT_LIEUTENANT = 1 << 26,
	BOT_TEMPLATE_APPLIED_LOOT_WEP_PREF_SUPPORT_PRIVATE    = 1 << 27,
	BOT_TEMPLATE_APPLIED_LOOT_WEP_PREF_SUPPORT_CORPORAL   = 1 << 28,
	BOT_TEMPLATE_APPLIED_LOOT_WEP_PREF_SUPPORT_SERGEANT   = 1 << 29,
	BOT_TEMPLATE_APPLIED_LOOT_WEP_PREF_SUPPORT_LIEUTENANT = 1 << 30,
};
