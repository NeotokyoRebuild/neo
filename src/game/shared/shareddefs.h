...
#ifdef NEO
#define NEO_RECON_VIEW_OFFSET Vector(0.0f, 0.0f, -3.0f)
#define NEO_RECON_MAXHULL_OFFSET Vector(0.0f, 0.0f, -6.0f)
#define NEO_RECON_DUCK_MAXHULL_OFFSET Vector(0.0f, 0.0f, -13.0f)
#define NEO_RECON_DUCKED_VIEW_OFFSET Vector(0.0f, 0.0f, -9.0f)

#define NEO_ASSAULT_VIEW_OFFSET Vector(0.0f, 0.0f, -2.5f)
#define NEO_ASSAULT_MAXHULL_OFFSET Vector(0.0f, 0.0f, -5.0f)
#define NEO_ASSAULT_DUCK_MAXHULL_OFFSET Vector(0.0f, 0.0f, -11.0f)
#define NEO_ASSAULT_DUCKED_VIEW_OFFSET Vector(0.0f, 0.0f, -9.0f)

#define NEO_SUPPORT_VIEW_OFFSET Vector(0.0f, 0.0f, 0.0f)
#define NEO_SUPPORT_MAXHULL_OFFSET Vector(0.0f, 0.0f, 0.0f)
...
#define NEO_JUGGERNAUT_MAXHULL_OFFSET Vector(0.0f, 0.0f, 16.0f)
#define NEO_JUGGERNAUT_DUCK_MAXHULL_OFFSET Vector(0.0f, 0.0f, 10.0f)
#define NEO_JUGGERNAUT_DUCKED_VIEW_OFFSET Vector(0.0f, 0.0f, 9.0f)
