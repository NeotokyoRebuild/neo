...
void TestDeserial_V2_ALPHA_V17()
{
	...
	TEST_COMPARE_INT(true, ValidateCrosshairSerial(szExportSeq, NEOXHAIR_SERIAL_ALPHA_V17));
}
...
void TestDeserial_V5_ALPHA_V28()
{
	...
	TEST_COMPARE_STR(szExportSeq, SERIAL_TEST_STR);
	TEST_COMPARE_INT(true, ValidateCrosshairSerial(szExportSeq, NEOXHAIR_SERIAL_ALPHA_V28));
}
...
void TestDeserial_V7_ALPHA_V35()
{
	// V7 - Changes segment-end token from ';' to ','
	static const char SERIAL_TEST_STR[] = "7,0,0,2,2,-1,0,3,2,4,1,6,5,7,1,-16776961,-16711936,-65536,";
	static const char SERIAL_TEST_LATEST_STR[] = CURRENT_VER ",0,0,2,2,-1,0,3,2,4,1,6,5,7,1,-16776961,-16711936,-65536,";
	...
	ExportCrosshair(&xhairInfo, szExportSeq, NEOXHAIR_SERIAL_ALPHA_V35);
	TEST_COMPARE_STR(szExportSeq, SERIAL_TEST_STR);
	TEST_COMPARE_INT(true, ValidateCrosshairSerial(szExportSeq));
}
...
void TestSerial_LongestLength()
{
	...
	CrosshairInfo xhairInfo = {};
	xhairInfo.wepFlags = CROSSHAIR_WEP_FLAG_SECONDARY | CROSSHAIR_WEP_FLAG_SHOTGUN |
		CROSSHAIR_WEP_FLAG_DEFAULT_HIPFIRE | CROSSHAIR_WEP_FLAG_SECONDARY_HIPFIRE |
		CROSSHAIR_WEP_FLAG_SHOTGUN_HIPFIRE | CROSSHAIR_WEP_FLAG_THROWABLE_HIPFIRE;
	xhairInfo.hipfireFlags = CROSSHAIR_HIPFIRECUSTOM_FLAG_DEFAULT | CROSSHAIR_HIPFIRECUSTOM_FLAG_SECONDARY |
		CROSSHAIR_HIPFIRECUSTOM_FLAG_SHOTGUN | CROSSHAIR_HIPFIRECUSTOM_FLAG_THROWABLE;
...
void TestFeature_Flags_OldBool_ToplineOff_SepDotColor()
{
	...
	static const char SERIAL_TEST_V6_STR[] = "6" ";0;0;3;2;-1;0;3;2;4;1;6;5;7;1;-16776961;-16711936;-65536;";
		...
		char (&szNames)[WEPFLAG_HIPFIRE_DATA__TOTAL][DATA_XTRA_NAME_SIZE])
{
	...
	int i = 0;
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",0,0,0,0,-1,");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",1,0,0,0,-1,3^");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",2,0,0,0,-1,3^");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",3,0,0,0,-1,6^");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",4,0,0,0,-1,");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",5,0,0,0,-1,3^");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",6,0,0,0,-1,3^");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",7,0,0,0,-1,6^");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",8,0,0,0,-1,");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",9,0,0,0,-1,3^");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",10,0,0,0,-1,3^");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",11,0,0,0,-1,6^");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",12,0,0,0,-1,");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",13,0,0,0,-1,3^");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",14,0,0,0,-1,3^");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",15,0,0,0,-1,6^");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",16,0,0,0,-1,");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",17,0,0,0,-1,3^");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",18,0,0,0,-1,3^");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",19,0,0,0,-1,6^");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",20,0,0,0,-1,");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",21,0,0,0,-1,3^");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",22,0,0,0,-1,3^");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",23,0,0,0,-1,6^");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",24,0,0,0,-1,");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",25,0,0,0,-1,3^");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",26,0,0,0,-1,3^");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",27,0,0,0,-1,6^");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",28,0,0,0,-1,");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",29,0,0,0,-1,3^");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",30,0,0,0,-1,3^");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",31,0,0,0,-1,6^");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",32,0,0,0,-1,");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",33,0,0,0,-1,3^");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",34,0,0,0,-1,3^");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",35,0,0,0,-1,6^");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",36,0,0,0,-1,");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",37,0,0,0,-1,3^");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",38,0,0,0,-1,3^");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",39,0,0,0,-1,6^");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",40,0,0,0,-1,");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",41,0,0,0,-1,3^");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",42,0,0,0,-1,3^");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",43,0,0,0,-1,6^");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",44,0,0,0,-1,");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",45,0,0,0,-1,3^");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",46,0,0,0,-1,3^");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",47,0,0,0,-1,6^");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",48,0,0,0,-1,");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",49,0,0,0,-1,3^");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",50,0,0,0,-1,3^");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",51,0,0,0,-1,6^");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",52,0,0,0,-1,");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",53,0,0,0,-1,3^");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",54,0,0,0,-1,3^");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",55,0,0,0,-1,6^");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",56,0,0,0,-1,");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",57,0,0,0,-1,3^");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",58,0,0,0,-1,3^");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",59,0,0,0,-1,6^");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",60,0,0,0,-1,");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",61,0,0,0,-1,3^");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",62,0,0,0,-1,3^");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",63,0,0,0,-1,6^");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",0,0,0,0,-1,");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",1,0,0,0,-1,,2,,,1,6^");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",2,0,0,0,-1,,2,,,1,6^");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",3,0,0,0,-1,,2,,,1,7^2,,,1,6^");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",4,1,0,0,-1,,2,,,1,6^");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",5,1,0,0,-1,,2,,,1,7^2,,,1,6^");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",6,1,0,0,-1,,2,,,1,7^2,,,1,6^");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",7,1,0,0,-1,,2,,,1,7^2,,,1,7^2,,,1,6^");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",8,2,0,0,-1,,2,,,1,6^");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",9,2,0,0,-1,,2,,,1,7^2,,,1,6^");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",10,2,0,0,-1,,2,,,1,7^2,,,1,6^");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",11,2,0,0,-1,,2,,,1,7^2,,,1,7^2,,,1,6^");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",12,3,0,0,-1,,2,,,1,17^");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",13,3,0,0,-1,,2,,,1,7^2,,,1,17^");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",14,3,0,0,-1,,2,,,1,7^2,,,1,17^");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",15,3,0,0,-1,,2,,,1,7^2,,,1,7^2,,,1,17^");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",16,4,0,0,-1,,2,,,1,6^");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",17,4,0,0,-1,,2,,,1,7^2,,,1,6^");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",18,4,0,0,-1,,2,,,1,7^2,,,1,6^");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",19,4,0,0,-1,,2,,,1,7^2,,,1,7^2,,,1,6^");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",20,5,0,0,-1,,2,,,1,17^");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",21,5,0,0,-1,,2,,,1,7^2,,,1,17^");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",22,5,0,0,-1,,2,,,1,7^2,,,1,17^");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",23,5,0,0,-1,,2,,,1,7^2,,,1,7^2,,,1,17^");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",24,6,0,0,-1,,2,,,1,7^2,,,1,6^");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",25,6,0,0,-1,,2,,,1,7^2,,,1,7^2,,,1,6^");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",26,6,0,0,-1,,2,,,1,7^2,,,1,7^2,,,1,6^");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",27,6,0,0,-1,,2,,,1,7^2,,,1,7^2,,,1,7^2,,,1,6^");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",28,7,0,0,-1,,2,,,1,28^");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",29,7,0,0,-1,,2,,,1,7^2,,,1,28^");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",30,7,0,0,-1,,2,,,1,7^2,,,1,28^");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",31,7,0,0,-1,,2,,,1,7^2,,,1,7^2,,,1,28^");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",32,8,0,0,-1,,2,,,1,6^");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",33,8,0,0,-1,,2,,,1,7^2,,,1,6^");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",34,8,0,0,-1,,2,,,1,7^2,,,1,6^");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",35,8,0,0,-1,,2,,,1,7^2,,,1,7^2,,,1,6^");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",36,9,0,0,-1,,2,,,1,17^");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",37,9,0,0,-1,,2,,,1,7^2,,,1,17^");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",38,9,0,0,-1,,2,,,1,7^2,,,1,17^");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",39,9,0,0,-1,,2,,,1,7^2,,,1,7^2,,,1,17^");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",40,10,0,0,-1,,2,,,1,7^2,,,1,6^");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",41,10,0,0,-1,,2,,,1,7^2,,,1,7^2,,,1,6^");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",42,10,0,0,-1,,2,,,1,7^2,,,1,7^2,,,1,6^");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",43,10,0,0,-1,,2,,,1,7^2,,,1,7^2,,,1,7^2,,,1,6^");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",44,11,0,0,-1,,2,,,1,28^");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",45,11,0,0,-1,,2,,,1,7^2,,,1,28^");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",46,11,0,0,-1,,2,,,1,7^2,,,1,28^");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",47,11,0,0,-1,,2,,,1,7^2,,,1,7^2,,,1,28^");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",48,12,0,0,-1,,2,,,1,7^2,,,1,6^");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",49,12,0,0,-1,,2,,,1,7^2,,,1,7^2,,,1,6^");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",50,12,0,0,-1,,2,,,1,7^2,,,1,7^2,,,1,6^");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",51,12,0,0,-1,,2,,,1,7^2,,,1,7^2,,,1,7^2,,,1,6^");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",52,13,0,0,-1,,2,,,1,28^");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",53,13,0,0,-1,,2,,,1,7^2,,,1,28^");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",54,13,0,0,-1,,2,,,1,7^2,,,1,28^");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",55,13,0,0,-1,,2,,,1,7^2,,,1,7^2,,,1,28^");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",56,14,0,0,-1,,2,,,1,7^2,,,1,7^2,,,1,6^");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",57,14,0,0,-1,,2,,,1,7^2,,,1,7^2,,,1,7^2,,,1,6^");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",58,14,0,0,-1,,2,,,1,7^2,,,1,7^2,,,1,7^2,,,1,6^");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",59,14,0,0,-1,,2,,,1,7^2,,,1,7^2,,,1,7^2,,,1,7^2,,,1,6^");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",60,15,0,0,-1,,2,,,1,39^");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",61,15,0,0,-1,,2,,,1,7^2,,,1,39^");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",62,15,0,0,-1,,2,,,1,7^2,,,1,39^");
	V_strcpy_safe(datas[i++].szSerial, CURRENT_VER ",63,15,0,0,-1,,2,,,1,7^2,,,1,7^2,,,1,39^");
	TEST_COMPARE_INT(i, ARRAYSIZE(datas));
}
...
TEST_INIT()
	...
	TEST_RUN(TestDeserial_V7_ALPHA_V35);
