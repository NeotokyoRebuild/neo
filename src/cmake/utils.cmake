...
function(split_debug_information)
    ...
    # Shared libraries carry the .so suffix; executables have none.
    get_target_property(TARGET_TYPE ${PARSED_ARGS_TARGET} TYPE)
    if(TARGET_TYPE STREQUAL "EXECUTABLE")
        set(SPLITDEBUG_FILE_NAME "${TARGET_OUTPUT_NAME}")
    else()
        set(SPLITDEBUG_FILE_NAME "${TARGET_OUTPUT_NAME}.so")
    endif()

    set(SPLITDEBUG_SOURCE "${CMAKE_CURRENT_BINARY_DIR}/${SPLITDEBUG_FILE_NAME}")
    set(SPLITDEBUG_TARGET "${CMAKE_CURRENT_BINARY_DIR}/${OUTPUT_SUBDIRECTORY}/${SPLITDEBUG_FILE_NAME}")
    set(SPLITDEBUG_TARGET_DEBUG "${CMAKE_CURRENT_BINARY_DIR}/${OUTPUT_SUBDIRECTORY}/${SPLITDEBUG_FILE_NAME}.debug")
