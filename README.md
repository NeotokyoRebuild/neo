...
Loading fonts and sounds with non-lowercase filepaths have been broken since the TF2-SDK/64-bit update on Linux, mainly affecting the NEUROPOL2 and X-SCALE fonts, and jitte sounds. To fix this, go to your NEOTOKYO installation folder and copy then rename the following to lowercase variant:
